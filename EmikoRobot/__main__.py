        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(
                            text="Source Code", url="https://github.com/OsmaniPro"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="👋Support", url="t.me/osmanigroupbot"
                        ),
                        InlineKeyboardButton(
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(
                            text="Osmani Pro", url="https://github.com/OsmaniPro"
                        ),
                        InlineKeyboardButton(
                            text="Sea Rosan", url="https://github.com/Searosan"
                        ),
                    ],
                    [
                        InlineKeyboardButton(text="Go Back", callback_data="emiko_"),
